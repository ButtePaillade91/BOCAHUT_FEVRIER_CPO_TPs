...
public class TP1_guessMyNumber_BOCAHUT_FEVRIER {
    ...
    public static void main(String[] args) {
        ...
        */
        System.out.println("Choisissez un mode de difficulté : \n1)Facile\n2)Normal\n3)Difficile"); // phrase destinée à l'utilisateur afin de choisir un niveau
        int lvl;
        int nbuser=0;
        int compteur=0;
        Scanner scan = new Scanner(System.in);
        lvl = scan.nextInt();
        while (lvl!=1 && lvl!=2 && lvl!=3) { // conditions pour boucler
        ...
        if (lvl == 1) { // différents niveaux
            int nbordi = generateurAleat.nextInt(100); // nombre aléatoire
            ...
            while (nbuser!=nbordi) {
                ...
                if (nbuser>nbordi) {
                    if (nbuser-nbordi>=25) {
                        System.out.println("vraiement trop grand"); // messages d'erreur
